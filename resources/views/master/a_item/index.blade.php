...
<h2>マスタ管理</h2>
<ul class="tabBtn">
  <li class="current"><a href="{{ route('a_items.index') }}">A項目</a></li>
  <li><a href="{{ route('c_items.index') }}">C項目</a></li>
  <li><a href="{{ route('obstetrics_items.index') }}">産科項目</a></li>
</ul>
...
<div class="panel panel-default">
  <div class="panel-heading">A項目マスターファイルのアップロード</div>
  <div class="panel-body">
    <div class="col-sm-20 double-margin-bottom">
      ...
      {{Form::open(['route' => 'a_items.upload', 'files' => true, 'class' => 'form-inline'])}}
        ...
        <div class="pull-right">
          <input name="commit" value="A項目を更新" class="btn btn-primary" data-disable-with="A項目を更新" type="submit">
        </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="pull-right"><a class="btn btn-primary" href="{{ route('a_items.download') }}">ダウンロード</a></div>
  </div>
</div>
...
<table class="table table-bordered">
  ...
  @foreach($items as $item)
    <tr>
      ...
      <td><a href="{{ route('a_items.edit', ['aitem' => $item->id ]) }}" class="">{{ $item->name }}</a></td>
      <td><a href="{{ route('a_items.edit', ['aitem' => $item->id ]) }}" class="">{{ $item->code }}</a></td>
      <td><a href="{{ route('a_items.edit', ['aitem' => $item->id ]) }}" class="">{{ $item->remark }}</a></td>
    </tr>
  @endforeach
  </tbody>
</table>
