...
<ul class="tabBtn">
  ...
  <li class="current"><a href="{{ route('c_items.index') }}">C項目</a></li>
...
<div class="panel panel-default">
  <div class="panel-heading">C項目マスターファイルのアップロード</div>
  <div class="panel-body">
    <div class="col-sm-20 double-margin-bottom">
      ...
      {{Form::open(['route' => 'c_items.upload', 'files' => true, 'class' => 'form-inline'])}}
        ...
        <div class="pull-right">
          <input name="commit" value="C項目を更新" class="btn btn-primary" data-disable-with="C項目を更新" type="submit">
        </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="pull-right"><a class="btn btn-primary" href="{{ route('c_items.download') }}">ダウンロード</a></div>
  </div>
</div>
...
<table class="table table-bordered">
  ...
  @foreach($items as $item)
    <tr>
      ...
      <td><a href="{{ route('c_items.edit', ['citem' => $item->id ]) }}" class="">{{ $item->remark }}</a></td>
    </tr>
  @endforeach
  </tbody>
</table>
